        ...
        <div class="row">
          <div class="col-md-9">
            <div class="row ">
              ...
              <div class="col-md-12 single_job_main">
                <h2>Location</h2>
                <iframe class="full-width-iframe" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3428.916507434128!2d76.78322631470263!3d30.748846681631466!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390fed76ab9f14c1%3A0xd6362b158b8994aa!2sEiffel%20Tower%20Replica!5e0!3m2!1sen!2sin!4v1581932177674!5m2!1sen!2sin" height="450" style="border:0;" allowfullscreen="" />
              </div>
              <div class="section-divider" />
              <div class="col-md-12 single_job_main">
                <h2>Similar Jobs</h2>
                <div class="row two_col featured_box_outer">
                  <div class="col-sm-6">
                    <div class="featured_box ">
                      ...
                      <div class="fb_action">
                        <a title="add to favourite" href="job-single.html#"><i class="far fa-heart" /></a>
                  ...
                  <div class="col-sm-6">
                    <div class="featured_box ">
                      ...
                      <div class="fb_action">
                        <a title="add to favourite" href="job-single.html#"><i class="fas fa-heart" /></a>
                        <a class="btn btn-third" href="job-single.html">Apply Now</a>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-12 text-center">
                    <a class="btn btn-primary" href="browse-jobs.html">Browse All Jobs <i class="fas fa-long-arrow-alt-right" /></a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-3 ">
            ...
            <div class=" sjs_box_action">
              <a class="btn btn-third" href="job-single.html#">Contact Employer</a>
              <p>- or -</p>
              <a class="btn btn-primary" href="job-single.html#">Apply Job</a>
            </div>
          </div>
        </div>
      </div>
