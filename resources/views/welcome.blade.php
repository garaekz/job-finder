        ...
        <div class="row two_col featured_box_outer">
            <div class="col-sm-6" >
                <div class="featured_box ">
                    ...
                    <div class="fb_action" >
                        <a title="add to favourite" href="index.html#"><i class="far fa-heart"></i></a>
            ...
            <div class="col-sm-6" >
                <div class="featured_box ">
                    ...
                    <div class="fb_action"  >
                        <a title="add to favourite" href="index.html#"><i class="fas fa-heart"></i></a>
                        <a class="btn btn-third" href="job-single.html">Apply Now</a>
                        <ul class="tags">
                            <li>Python</li>
                            <li>Flask</li>
...
<div class="section gray  partner_section">
    ...
    <div class="container">
        ...
        <ul class="partner_carousel owl-carousel owl-theme">
            <li>
                <a href="index.html#"><img  alt="brand logo" src="assets/images/company-logo-1.svg"></a>
            </li>
            <li>
                <a href="index.html#"><img   alt="brand logo" src="assets/images/company-logo-2.svg"></a>
            </li>
            <li>
                <a href="index.html#"><img   alt="brand logo" src="assets/images/company-logo-3.svg"></a>
            </li>
            <li>
                <a href="index.html#"><img  alt="brand logo" src="assets/images/company-logo-4.png"></a>
            </li>
            <li>
                <a href="index.html#"><img   alt="brand logo" src="assets/images/company-logo-5.png"></a>
            </li>
            <li>
                <a href="index.html#"><img   alt="brand logo" src="assets/images/company-logo-1.svg"></a>
            </li>
